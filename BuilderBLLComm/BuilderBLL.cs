...
namespace Maticsoft.BuilderBLLComm
{
    ...
    public class BuilderBLL : IBuilder.IBuilderBLL
    {
        ...
        public string GetBLLCode(bool Maxid, bool Exists, bool Add, bool Update, bool Delete, bool GetModel, bool GetModelByCache, bool List)
        {
            ...
            if (GetModelByCache)
            {
                strclass.AppendLine("using " + NameSpace + ".Common;");
            }
            ...
            strclass.AppendLine(GetLinqString());
        ...
        public string CreatBLLGetModel()
        {
            ...
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, KeysNullTip);
            strclass.AppendSpaceLine(3, "return dal.GetModelByWhere(strWhere);");
            strclass.AppendSpaceLine(2, "}");
        ...
        public string CreatBLLGetList()
        {
            ...
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "return dal.GetList(customerSQL,strWhere);");
            strclass.AppendSpaceLine(2, "}");
            ...
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "return dal.GetList(customerSQL,strWhere,filedOrder);");
            strclass.AppendSpaceLine(2, "}");
                ...
                (DbType == "SQL2008") || (DbType == "SQL2012"))
            {
                ...
                strclass.AppendSpaceLine(2, "{");
                strclass.AppendSpaceLine(3, "return dal.GetTopList(Top,strWhere,filedOrder);");
                strclass.AppendSpaceLine(2, "}");
                ...
                strclass.AppendSpaceLine(2, "{");
                strclass.AppendSpaceLine(3, "return dal.GetTopList(Top,customerSQL,strWhere,filedOrder);");
                strclass.AppendSpaceLine(2, "}");
            }
...
*/
        ...
        public string GetLinqString()
        {
            ...
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "return dal.GetTableModelList();");
            strclass.AppendSpaceLine(2, "}");
            ...
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "return dal.GetQueryModelList(strWhere);");
            strclass.AppendSpaceLine(2, "}");
            ...
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "return dal.GetQueryModelList(customerSQL, strWhere);");
            strclass.AppendSpaceLine(2, "}");
            ...
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "return dal.GetQueryModelList(customerSQL, strWhere,filedOrder);");
            strclass.AppendSpaceLine(2, "}");
            ...
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "return dal.GetQueryModelTopList(Top, strWhere);");
            strclass.AppendSpaceLine(2, "}");
            ...
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "return dal.GetQueryModelTopList(Top, strWhere,filedOrder);");
            strclass.AppendSpaceLine(2, "}");
            ...
            strclass.AppendSpaceLine(2, "{");
            strclass.AppendSpaceLine(3, "return dal.GetQueryModelTopList(Top, customerSQL, strWhere,filedOrder);");
            strclass.AppendSpaceLine(2, "}");
