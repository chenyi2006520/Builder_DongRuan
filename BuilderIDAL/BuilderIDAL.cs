...
namespace Maticsoft.BuilderIDAL
{
    ...
    public class BuilderIDAL : IBuilder.IBuilderIDAL
    {
        ...
        public string GetIDALCode(bool Maxid, bool Exists, bool Add, bool Update, bool Delete, bool GetModel, bool List)
        {
            ...
            strclass.AppendSpaceLine(1, "/// 接口层" + TableDescription + "的摘要说明");
            strclass.AppendSpaceLine(1, "/// </summary>");
        ...
        public string GetTableModelList()
        {
            ...
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "Table<" + ModelSpace + "> GetTableModelList();");
        ...
        public string GetQueryModelList()
        {
            ...
            strclass.AppendSpaceLine(2, "/// </summary>");
            strclass.AppendSpaceLine(2, "IEnumerable<" + ModelSpace + "> GetQueryModelList(string strWhere);");
            return strclass.Value;
        }
        #endregion
    }
